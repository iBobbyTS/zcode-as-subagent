...
fn control_contract(
    ...
    GeneralControlContract {
        ...
        rules: [
            ...
            "Use only repository-relative context and write-manifest paths attributed above; for workspace-write tasks perform the requested edit directly without asking the user for clarification.",
